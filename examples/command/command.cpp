...
void  send_request(std::string message)
{
  ...
  //std::string data = std::string("{\"text\":\"") + std::string(message);
  ...
  curl_easy_setopt(hnd, CURLOPT_URL, "http://localhost:5005/webhooks/whisper_assistant/webhook");
  curl_easy_setopt(hnd, CURLOPT_NOPROGRESS, 1L);
  curl_easy_setopt(hnd, CURLOPT_POSTFIELDS, R"('text':'Tell me a joke')");
  ...
  curl_easy_setopt(hnd, CURLOPT_URL, "http://localhost:5005/webhooks/whisper_assistant/webhook");
  curl_easy_setopt(hnd, CURLOPT_NOPROGRESS, 1L);
  curl_easy_setopt(hnd, CURLOPT_POSTFIELDS, char_arr);
  curl_easy_setopt(hnd, CURLOPT_POSTFIELDSIZE_LARGE, (curl_off_t)256);
  curl_easy_setopt(hnd, CURLOPT_HTTPHEADER, slist1);
  curl_easy_setopt(hnd, CURLOPT_USERAGENT, "curl/8.4.0");
  curl_easy_setopt(hnd, CURLOPT_MAXREDIRS, 50L);
  curl_easy_setopt(hnd, CURLOPT_HTTP_VERSION, (long)CURL_HTTP_VERSION_2TLS);
